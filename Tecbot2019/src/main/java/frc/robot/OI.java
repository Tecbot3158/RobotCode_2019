...
public class OI {
	...
	public OI() {
		...
		// b.whenPressed(new MoveAngler(TecbotConstants.ARM_ANGLER_DEPLOY_HATCH_CARGO, TecbotConstants.ARM_ANGLER_MAX_POWER));
		// x.whenPressed(new MoveAngler(TecbotConstants.ARM_ANGLER_TRANSPORT, TecbotConstants.ARM_ANGLER_MAX_POWER));
		// y.whenPressed(new CancelArm());
		// lb.whenPressed(new MoveAngler(TecbotConstants.ARM_ANGLER_DEPLOY_BALL_LOWER_ROCKET, TecbotConstants.ARM_ANGLER_MAX_POWER));
		// rb.whenPressed(new MoveAngler(TecbotConstants.ARM_ANGLER_DEPLOY_BALL_MIDDLE_ROCKET, TecbotConstants.ARM_ANGLER_MAX_POWER));
		...
		//b_copilot.whenPressed(new MoveExtensor(TecbotConstants.ARM_EXTENSOR_UP_POSITION, TecbotConstants.ARM_EXTENSOR_MAX_POWER));
