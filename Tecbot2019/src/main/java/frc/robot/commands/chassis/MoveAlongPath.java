...
public class MoveAlongPath extends Command {
    ...
    protected void initialize() {
        ...
        m_left_follower.configureEncoder((int)Robot.driveTrain.getLeftPosition(), RobotMap.k_tic_per_revolution,
    ...
    protected void execute() {
        ...
        double leftSpeed = m_left_follower.calculate((int)Robot.driveTrain.getLeftPosition());
        double rightSpeed = m_right_follower.calculate((int)Robot.driveTrain.getRightPosition());
